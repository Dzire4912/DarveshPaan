...
{
    public class KronosFacilitiesVM
    {
        public List<KronosFacilities> kronos { get; set; }     
        public List<KronosDataTrack> tracks { get; set; }
        ...
        public List<KronosUnprocessedData> KronosUnprocessedData { get; set; }    
