    ...
    e.sessionTimeout = function (t) {
        ...
        var a,
            r = {
                ...
                ajaxType: "POST",
                ajaxData: "",
                redirUrl: "https://localhost:7032/Identity/Account/Login",
                logoutUrl: "https://localhost:7032/Identity/Account/Login",
                warnAfter: 9e5,
                redirAfter: 12e5,
        ...
        if ("function" != typeof d.onWarn) {
            ...
            e("body").append(
                ...
                e("#session-timeout-dialog-keepalive").on("click", function () {
