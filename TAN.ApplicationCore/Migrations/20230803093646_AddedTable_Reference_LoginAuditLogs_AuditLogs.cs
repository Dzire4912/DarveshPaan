...
{
    /// <inheritdoc />
    public partial class AddedTable_Reference_LoginAuditLogs_AuditLogs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoginAuditLogs", x => x.LoginAuditId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RefereceId = table.Column<int>(type: "int", nullable: false),
                    GroupiTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
